...
import Multi__Type_For_Answer from "../multiAnsQuiz/newIndex";
import Quiz_Type_Answer from "../quiz/newIndex";
import Typing_Answer_Template from "../type_question/newIndex";
          ...
          >
            ...
            {(() => {
              switch (type) {
                case "Quiz":
                    // return <Quiz_Answer/>
                    return <Quiz_Type_Answer choices={question.choices} setQuestion= {setQuestion} question = {question} />
                case "Type Answer":
                    // return <Type_Answer/>
                    return <Typing_Answer_Template setQuestion= {setQuestion} question = {question}/>
                case "Multi Answer Question":
                    // return <Multi_Ans_Quiz_Answer/>
                    return <Multi__Type_For_Answer choices={question.choices} setQuestion= {setQuestion} question = {question}
